...
router.get('/:id/pdf', (req, res) => {
  try {
    ...
    // Footer - placed relative to content, not at a fixed position
    doc.fontSize(7).fillColor('#999').text('Generated by Basic ITS - Cost Build Up System', 50, y, { align: 'center', width: 512 });
